...
function maillinge($recipient, $subject, $body){
  ...
  $signature = '<p><span style="color:#FFC300;font-size:20px">SNAPSHOT TOURS & SAFARIS - Website Form</span></p>';
  ...
  $mailer->send($message);*/
     ...
     try {
         ...
         $mail->setFrom($senderEmail, 'New Website Enquiry');
         
         //Recipients
         $mail->addAddress($recipient);              
         $mail->addReplyTo($senderEmail, 'New Website Enquiry');
...
function maillingycn($recipient, $subject, $body){
  
  $signature = '<p>Regards,<br><span style="color:#FFC300;font-size:20px">Nadvigator</span></p>';
  /*$hostname = 'smtp.cloudmta.net';
  $username = '7c3c506dea731b2f';
  $password = 'Mh812rKx4TQCm6XNTjmpGkGB';
  ...
  $mailer->send($message);*/
     ...
     try {
         ...
         $mail->setFrom($senderEmail, 'Nadvigator');
         
         //Recipients
         $mail->addAddress($recipient);              
         $mail->addReplyTo('noreply@ganiamtech.com', 'Nadvigator');
