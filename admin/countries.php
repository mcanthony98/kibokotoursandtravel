...
$qry = $conn->query("SELECT * FROM country ORDER BY country_name ASC");
			...
			<div class="row">
				<div class="col-12 mb-4 mb-sm-5">
					<div class="d-sm-flex justify-content-between align-items-center">
						<h1 class="h3 mb-2 mb-sm-0">Countries</h1>
				...
				<div class="card-body">
					...
					<div class="row row-cols-xl-7 align-items-lg-center border-bottom g-4 px-2 py-4">
						...
						<div class="col">
							...
							<div class="d-flex align-items-center">
								...
								<div class="avatar avatar-xl flex-shrink-0">
									<img class="avatar-img " src="../uploads/<?php echo $row['country_image'];?>" alt="avatar">
								</div>
								<!-- Info -->
								<div class="ms-2">
						...
						<div class="col d-none d-lg-block">
							...
							<h6 class="mb-0 fw-normal"><?php echo $row['country_description'];?></h6>
						</div>
