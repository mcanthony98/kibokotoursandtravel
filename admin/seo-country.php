			...
			<div class="row">
				<div class="col-12 mb-2 mb-sm-2">
					<div class="d-sm-flex justify-content-between align-items-center">
						<h1 class="h3 mb-2 mb-sm-0">Edit Country (SEO)</h1>
						<div class="d-grid"><a href="edit-country.php?cat=<?php echo $cou_id;?>" class="btn btn-primary-soft btn-sm mb-0"> Basic Settings</a></div>	
					</div>
				</div>
			</div>
				...
				<form class="vstack gap-4" enctype="multipart/form-data" method="post" action="processes/processes.php">
					...
					<div class="card shadow">
						...
						<div class="card-body">
							<div class="row g-3">
								...
								<div class="col-12">
									...
									<input class="form-control" type="text" name="tit" value="<?php echo $row['seo_title'];?>" placeholder="Enter title" readonly>
								</div>
								...
								<div class="col-12">
									...
									<textarea class="form-control" rows="4" name="desc" placeholder="Enter Keywords"><?php echo $row['seo_keywords'];?></textarea>
								</div>
                        ...
                        <div class="card-footer text-end">
                            <button type="submit" name="edit-seo-country" class="btn btn-primary mb-0">Save Changes</button>
                            </form>
                        </div>
					</div>
					<!-- Cab Detail END -->
