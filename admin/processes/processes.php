...
elseif(isset($_POST["add-destination"])){
    ...
    $cat_insert = "INSERT INTO destination (destination_name, destination_slag, destination_image, description, location, map_iframe, country_id, catchy_title) VALUES ('$cat',  '$slag', '$new', '$desc', '$loc', '$map', '$country', '$ccat')";
...
elseif(isset($_POST["add-package"])){
    ...
    $cat_insert = "INSERT INTO package (title, title_slag, subtitle, package_description, price, package_image, last_modified) VALUES ('$tit',  '$slag', '$stit', '$desc', '$price', '$new', '$date')";
...
elseif(isset($_POST["edit-package"])){
    ...
    $cat_insert = "UPDATE package SET title='$tit', title_slag='$slag', subtitle='$stit', package_description='$desc', price='$price', package_status='$status', last_modified='$date' WHERE package_id  = '$pack_id'";
