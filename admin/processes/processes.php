...
elseif(isset($_POST["add-package"])){
    ...
    $cat_insert = "INSERT INTO package (title, title_slag, subtitle, package_description, price, package_image, last_modified, travel_dates, category_id) VALUES ('$tit',  '$slag', '$stit', '$desc', '$price', '$new', '$date', '$dates', '$cat')";
