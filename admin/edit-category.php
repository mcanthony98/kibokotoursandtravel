						...
						<div class="card-body">
							<div class="row g-3">
								...
								<div class="col-12">
									...
									<input class="form-control" type="text" name="cat" value="<?php echo $row['category_name'];?>" placeholder="Enter Category Name" required>
								</div>

								<!-- Desc -->
								<div class="col-12">
									<label class="form-label">Description (Approx 20 Words)</label>
									<textarea class="form-control" rows="3" name="desc" placeholder="Enter Description" required><?php echo $row['description'];?></textarea>
								</div>
