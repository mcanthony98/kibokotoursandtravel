						...
						<div class="card-body">
							<div class="row g-3">
								...
								<div class="col-12">
									...
									<input class="form-control" type="text" name="cat" placeholder="Enter Destination Name">
								</div>
								...
								<div class="col-12">
									...
									<input class="form-control" type="text" name="loc" placeholder="Enter Destination Location">
								</div>
