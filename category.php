		...
		<div class="p-3 p-sm-5 rounded-3" style="background-image: url(assets/images/bg/04.jpg); background-position: center center; background-repeat: no-repeat; background-size: cover;">
			...
			<div class="row"> 
				<div class="col-md-8 mx-auto my-5 "> 
					<h1 class="text-center text-dark py-5">Kenya </h1>
					<ul class="nav nav-divider h6 text-dark mb-0 justify-content-center">
						<li class="nav-item">15 Destination</li>
						<li class="nav-item">10 Package</li>
					</ul>
				</div>
			</div>
		</div>
...
<!-- =======================
About START -->
<section class="pt-2 pt-md-3 pb-0">
			...
			<div class="col-lg-10 m-auto text-center">
				...
				<ul class="list-inline hstack gap-4 flex-wrap justify-content-center mt-4">
					<li class="list-inline-item">
						<h5 class="mb-0 fw-normal"><i class="bi bi-pin-map fa-fw text-warning me-1"></i>15 Destinations</h5>
					</li>
					<li class="list-inline-item"> 
						<h5 class="mb-0 fw-normal"><i class="bi bi-wallet fa-fw text-danger me-1"></i>6 Packages</h5>
					</li>
					<li class="list-inline-item">
						<h5 class="mb-0 fw-normal"><i class="bi bi-star fa-fw text-success me-1"></i>24 Happy Clients</h5>
					</li>	
				</ul>
				...
				<div class="d-sm-flex justify-content-center align-items-center mt-4">
					...
					<div class="d-flex justify-content-center align-items-center text-start me-0 me-sm-4">
						...
						<div>
							...
							<p class="mb-0 small">Clients Love Kenya!</p>
						</div>
					</div>
					<!-- Button -->
				</div>
...
<!-- =======================
Packages START -->
<section class="pt-5 pt-md-5 mt-5">
	<div class="container">
		<!-- Title -->
		<div class="row mb-5">
			<div class="col-12 text-center">
				<h2 class="mb-0">Destinations in Kenya</h2>
			</div>
		</div>
...
<!-- =======================
Top category START -->
<section class="pt-0 pt-md-5 mt-5">
	<div class="container">
		<!-- Title -->
		<div class="row mb-3 mb-sm-4">
			<div class="col-12 text-center">
				<h2 class="mb-2">Experiences in Kenya</h2>
			</div>
		</div>
		...
		<div class="row g-4">
			...
			<div class="col-md-6 col-xl-4">
				<div class="card card-hover-shadow pb-0 h-100">
					...
					<div class="card-body px-3">
						<!-- Title -->
						<h5 class="card-title mb-0"><a href="package.php" class="stretched-link">The Beest in the Wild</a></h5>
						<span class="small"><i class="far fa-calendar-alt me-2"></i>10 Day Trip</span>
					</div>
					<!-- Card body END -->
			...
			<div class="col-md-6 col-xl-4">
				<div class="card card-hover-shadow pb-0 h-100">
					...
					<div class="card-body px-3">
						<!-- Title -->
						<h5 class="card-title mb-0"><a href="package.php" class="stretched-link">Magical Kenya</a></h5>
						<span class="small"><i class="far fa-calendar-alt me-2"></i>6 Day Trip</span>
					</div>
					<!-- Card body END -->
			...
			<div class="col-md-6 col-xl-4">
				<div class="card card-hover-shadow pb-0 h-100">
					...
					<div class="card-body px-3">
						<!-- Title -->
						<h5 class="card-title mb-0"><a href="package.php" class="stretched-link">Sun of Zanzibar</a></h5>
						<span class="small"><i class="far fa-calendar-alt me-2"></i>10 Day Trip</span>
					</div>
					<!-- Card body END -->
	...
	<div class="modal-dialog modal-dialog-centered modal-lg">
		<div class="modal-content">
			...
			<div class="modal-header">
				<h5 class="modal-title" id="mapmodalLabel">Maasai Mara National Park Location</h5>
