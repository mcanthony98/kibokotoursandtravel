...
$res = $conn->query("SELECT * FROM blog WHERE blog_status='1' ORDER BY blog_id DESC");
...
<head>
	<title>Our Blogs | Snapshot Tours and Safaris</title>
		...
		?>
			...
			<div class="col-md-6 col-lg-4">
				<div class="card bg-transparent">
					<!-- Image -->
					<a href="blog.php?blog=<?php echo $row['blog_id'];?>&name=<?php echo $row['blog_slag'];?>">
					<div class="position-relative w-100">
						...
						<div class="card-img-overlay p-3">
							<span class="badge text-bg-<?php echo $row['blog_category_color'];?> mb-2"><?php echo $row['blog_category'];?></span>
						</div>
					</div>
					</a>
					...
					<div class="card-body p-3 pb-0">
						<!-- Title -->
						<h5 class="card-title mt-2"><a href="blog.php?blog=<?php echo $row['blog_id'];?>&name=<?php echo $row['blog_slag'];?>"><?php echo $row['blog_title'];?></a></h5>
