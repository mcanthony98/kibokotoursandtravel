...
Our Stats START -->
        <section class="py-0 py-lg-7">
            <div class="container">
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        <h2>Discover nature's grandeur with us</h2>
                        <p class="mb-0">Kiboko Tours and Travel is a Kenyan tour company with a unique approach to life
                        ...
                        <div
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <h3 class="purecounter text-primary mb-0" data-purecounter-start="0"
                                    data-purecounter-end="24" data-purecounter-delay="200">0</h3>
                                <h6 class="fw-normal mb-0">Tour Packages</h6>
                            </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="d-flex justify-content-center me-3">
                                    <h3 class="purecounter text-primary mb-0" data-purecounter-start="0"
                                        data-purecounter-end="70" data-purecounter-delay="300">0</h3>
                        ...
                        <ul class="list-group list-group-borderless">
                            <li class="list-group-item py-3">
                                <h6 class="mb-0 fw-normal">
                                    <i class="bi bi-cash-coin fa-fw text-info me-2"></i>Value for Money Guaranteed
                                </h6>
                            </li>

                            <li class="list-group-item py-3">
                                <h6 class="mb-0 fw-normal">
                                    <i class="bi bi-credit-card-2-back fa-fw text-warning me-2"></i>Variety of Payment
                                    Options
                                </h6>
                            </li>
